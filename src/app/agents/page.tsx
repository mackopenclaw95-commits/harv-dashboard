...
const FALLBACK_AGENTS: Agent[] = [
  { name: "Harv", status: "LIVE", model: "claude-haiku-4-5-20251001", type: "agent", tier: "AGENTS", provider: "anthropic", description: "Main brain — Cars 1 personality, routes invisibly through Router", cost_per_call: 0.004672 },
  ...
  { name: "Guardian", status: "LIVE", model: "qwen2.5:0.5b", type: "background", tier: "BACKGROUND", provider: "ollama", description: "System monitor — watches for issues and keeps everything running smoothly", cost_per_call: 0 },
  ...
  { name: "Video Digest", status: "LIVE", model: "deepseek/deepseek-chat", type: "agent", tier: "AGENTS", provider: "openrouter", description: "Video implementation assistant — transcripts, digests, and actionable breakdowns", cost_per_call: 0.002 },
  { name: "YouTube Digest", status: "LIVE", model: "deepseek/deepseek-chat", type: "agent", tier: "AGENTS", provider: "openrouter", description: "YouTube video summaries, transcript analysis, implementation notes", cost_per_call: 0.002 },
  ...
  { name: "Medic", status: "LIVE", model: "qwen2.5:0.5b", type: "background", tier: "BACKGROUND", provider: "ollama", description: "Error scanner — checks for bugs every 6 hours and auto-fixes when possible", cost_per_call: 0 },
  { name: "Heartbeat", status: "LIVE", model: "qwen2.5:0.5b", type: "background", tier: "BACKGROUND", provider: "ollama", description: "System pulse — runs health checks, processes tasks, and syncs data", cost_per_call: 0 },
